# Anna's response code for answering questions during MLA 2017.
# combines Twitter event listener, with thermal printer support (comment out printer if not wanted).
# Anna was supposed to print live as well as tweet, but she was uncooperative on the day. bad connection.
# make a Twitter app to get OAUTH credentials, and replace "user" with your twitter handle in line 89.
# if you want the text to print on terminal instead of a printer, remover "printer" from the "printer.println" command.
