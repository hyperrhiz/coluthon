# Script code for Anna Coluthon's "response" instantiation, compiled from the NLTK Eliza Project
# Featuring response text for Anna Coluthon, from Roland Barthes' A Lover's Discourse
# You'll need to install the Python NLTK Library before you start
# Twitter credentials and event listener are in the script named anna.py
